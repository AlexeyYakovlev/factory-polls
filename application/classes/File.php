...
class File extends Kohana_File {
     ...
     * каталога не существует или он не доступен для чтения возвращается NULL, в 
     * противном случае возвращаем имя полученного каталога.
     * @param string $dir каталог
     */
    public static function ChekDir($dir) {
        // Если каталог существует и доступен для чтения
        if (is_readable(APPPATH . $dir))
